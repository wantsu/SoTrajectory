...
from model.Model_utils import make_mlp, sample_noise, Extractor, PoolHiddenNet
...
class TrajectoryGenerator(nn.Module):
    def __init__(
        ...
        pool_every_timestep=True, dropout=0, bottleneck_dim=1024,
        ...
        self.extractor = Extractor(pooling_type, embedding_dim, encoder_h_dim,
    ...
    def add_noise(self, _input, seq_start_end, user_noise=None):
        ...
        if user_noise is not None:
            ...
            z_decoder = sample_noise(noise_shape, self.noise_type)
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, user_noise=None):
        ...
        # Encode seq
        mlp_decoder_context_input = self.extractor(obs_traj, obs_traj_rel, seq_start_end, user_noise)
